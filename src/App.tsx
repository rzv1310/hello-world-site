      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full -mt-[50px] sm:mt-[50px]">
        ...
        >
          ...
          <div>
            ...
            >
              <a href="#calculator" className="inline-flex items-center justify-center whitespace-nowrap px-4 py-2 sm:px-8 sm:py-4 bg-brand-navy/40 backdrop-blur-md border border-white/20 sm:bg-brand-navy sm:backdrop-blur-none sm:border-0 hover:bg-brand-navy/60 sm:hover:bg-brand-navy-light text-white text-sm sm:text-base font-medium rounded transition-colors shadow-lg hover:shadow-xl w-auto">
