      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full -mt-[50px] sm:mt-[50px]">
        ...
        >
          ...
          <div className="flex flex-col gap-2 sm:gap-0">
            ...
            >
              <a href="#calculator" <a href="#calculator" className="inline-flex items-center justify-center whitespace-nowrap px-4 py-2 sm:px-8 sm:py-4 bg-brand-navy hover:bg-brand-navy-light text-white text-[18px] sm:text-lg font-serif font-medium rounded transition-colors shadow-lg hover:shadow-xl w-auto">>
...
const TrustStrip = () => {
  ...
  return (
    <div className="relative overflow-hidden h-[calc(26.8vw+220px)] bg-[#FDFBF7] flex items-center justify-center">
