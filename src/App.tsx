      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full -mt-[50px] sm:mt-[50px]">
        ...
        >
          ...
          <div>
            ...
            >
              <a href="#calculator" className="inline-flex items-center justify-center whitespace-nowrap px-8 py-4 bg-white/10 backdrop-blur-md border border-white/20 sm:bg-brand-navy sm:backdrop-blur-none sm:border-0 hover:bg-white/20 sm:hover:bg-brand-navy-light text-white font-medium rounded transition-colors shadow-lg hover:shadow-xl w-auto sm:w-auto">
