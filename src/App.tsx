        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            <div className="flex items-center gap-4 mb-6">
              ...
              <a href="https://www.linkedin.com/company/helenico-advisory" target="_blank" rel="noopener noreferrer" className="hover:text-brand-gold transition-colors">
              ...
              <a href="https://www.facebook.com/helenicoadvisory" target="_blank" rel="noopener noreferrer" className="hover:text-brand-gold transition-colors">
                <svg className="w-5 h-5 text-white hover:text-brand-gold transition-colors" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
            </div>
            <h2 className="text-lg font-semibold mb-2">HELENICO ADVISORY</h2>
            <ul className="space-y-1 text-sm text-white/60">
              ...
              <li className="pt-1">Luni - Sâmbătă: 09 - 19</li>
              <li>Duminică: Închis</li>
            </ul>
            <div className="mt-4 rounded-lg overflow-hidden">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2633.8316227754763!2d26.160541111508138!3d44.4333735209552!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40b1feb5606f19cd%3A0xd44ed50793355!2sAnsambul%20Rezidential%20Noor%2C%20Intrarea%20Horbotei%2012%2C%20077085%20Bucure%C8%99ti!5e1!3m2!1sro!2sro!4v1773855486507!5m2!1sro!2sro" width="100%" height="180" style={{border: 0}} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" className="rounded-lg"></iframe>
            </div>
          </div>
  ...
  return (
    <BrowserRouter>
      ...
      <div className="min-h-screen bg-brand-beige selection:bg-brand-gold selection:text-white">
        ...
        <a
          href="https://wa.me/40745300600"
          target="_blank"
          rel="noopener noreferrer"
          className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-brand-navy hover:bg-brand-navy-light rounded-full flex items-center justify-center shadow-lg transition-colors"
          aria-label="WhatsApp"
        >
