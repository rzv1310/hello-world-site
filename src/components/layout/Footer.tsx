        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            ...
            <div className="mt-4 rounded-lg overflow-hidden">
              <a href="https://maps.app.goo.gl/xVUxJ5v4YVU6Dune9" target="_blank" rel="noopener noreferrer">
                <img src="/helenico-advisory-audit-statutar-google-maps.webp" alt="Locația Helenico Advisory pe Google Maps" title="Locația Helenico Advisory pe Google Maps" className="rounded-lg w-full h-auto" loading="lazy" />
              </a>
            </div>
          </div>
