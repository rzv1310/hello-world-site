        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            <div className="flex items-center gap-4 mb-6">
              <Link to="/"><img src="/logo-helenico-advisory.webp" alt="Helenico Advisory" className="h-16 w-auto brightness-0 invert" loading="lazy" /></Link>
            ...
            <h2 className="text-lg font-semibold mb-2"><Link to="/" className="hover:text-brand-gold transition-colors">HELENICO ADVISORY</Link></h2>
